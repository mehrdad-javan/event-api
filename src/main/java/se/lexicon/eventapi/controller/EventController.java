...
import se.lexicon.eventapi.service.EventService;
...
public class EventController {
    ...
    public ResponseEntity<Void> addParticipant(
            ...
            @Valid @RequestBody EventParticipantRequestDTO participantRequestDto) {
        eventService.addParticipant(eventId, participantRequestDto);
